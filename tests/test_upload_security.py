...
class TestUploadSecurity:
    ...
    def _create_mock_upload_file(self, filename, file_obj, size):
    ...
    async def test_save_upload_file_chunked(self, mock_validate):
        ...
        upload_file = self._create_mock_upload_file(filename, file_obj, len(content))
    ...
    async def test_save_upload_file_spoofed_content_length(self):
        ...
        upload_file = self._create_mock_upload_file("spoofed_file.txt", file_obj, 1024)
