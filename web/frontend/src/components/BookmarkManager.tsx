...
const BookmarkManager: React.FC<BookmarkManagerProps> = ({
  ...
  // Filter bookmarks based on search and tag (memoized for performance)
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          >
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="Close bookmark manager">
              <title>Close bookmark manager</title>
        ...
        <div className="px-6 py-4 border-b border-gray-200 space-y-4">
          ...
          <div className="relative">
            ...
            />
            <svg className="absolute left-3 top-2.5 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="Search icon">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              {isExporting ? (
                ...
                <svg className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="Export icon">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      ...
                      >
                        {deletingIds.has(bookmark.id) ? (
                          ...
                          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="Delete bookmark">
