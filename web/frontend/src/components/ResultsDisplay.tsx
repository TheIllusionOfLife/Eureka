...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ 
  ...
  const handleBookmark = (result: IdeaResult, index: number) => {
    if (onBookmarkToggle) {
      onBookmarkToggle(result, index);
    }
  };
          ...
          <div key={index} className="p-6 fade-in">
            ...
            <div className="mt-4 flex space-x-3">
              <button 
                ...
                className={`inline-flex items-center px-3 py-2 border ${isBookmarked(index) ? 'border-blue-500 bg-blue-50' : 'border-gray-300'} shadow-sm text-sm leading-4 font-medium rounded-md ${isBookmarked(index) ? 'text-blue-700' : 'text-gray-700'} bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}>
                ...
                {isBookmarked(index) ? 'Bookmarked' : 'Bookmark'}
              </button>
